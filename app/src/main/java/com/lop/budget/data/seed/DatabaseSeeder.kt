...
object DatabaseSeeder {
    ...
    suspend fun seed(db: LopDatabase) {
        ...
        suspend fun getOrUpsertGoal(
            ...
            return existing?.id ?: goalDao.upsert(
                GoalEntity(
                    name = name,
                    targetAmount = target,
                    savedAmount = saved,
        ...
        suspend fun getOrUpsertSeries(
            ...
            return existing?.id?.toString() ?: seriesDao.upsert(
        ...
        val salaryCat =
            getOrUpsertCat("Salaire", TransactionType.INCOME, 0xFF4CAF50.toInt(), "work", catIncome)
        getOrUpsertCat(
            "Bonus / Prime",
        ...
        // Loisirs & Culture
        val catLeisure =
            getOrUpsertCat("Loisirs", TransactionType.EXPENSE, 0xFF9C27B0.toInt(), "sports_esports")
        getOrUpsertCat(
            "Cinéma / Sorties",
            TransactionType.EXPENSE,
            0xFFAB47BC.toInt(),
        ...
        // Shopping
        val catShop =
            getOrUpsertCat("Shopping", TransactionType.EXPENSE, 0xFFE91E63.toInt(), "shopping_bag")
        getOrUpsertCat(
            "Vêtements",
            TransactionType.EXPENSE,
            0xFFEC407A.toInt(),
        ...
        // Santé
        val catHealth =
            getOrUpsertCat("Santé", TransactionType.EXPENSE, 0xFF00BCD4.toInt(), "medical_services")
        getOrUpsertCat(
            "Médecin / Spécialiste",
            TransactionType.EXPENSE,
            0xFF26C6DA.toInt(),
