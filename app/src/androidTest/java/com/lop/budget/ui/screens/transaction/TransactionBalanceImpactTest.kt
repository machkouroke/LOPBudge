...
class TransactionBalanceImpactTest {
    ...
    // Aujourd'hui (très proche) pour être sûr qu'elle soit dans "Transactions récentes"
    ...
    fun shouldShowAlertWhenModifyingOldPaidTransactionFromHome() {
        ...
        // On clique d'abord pour donner le focus proprement
        ...
        composeTestRule.onNodeWithTag("impact_alert_dialog").assertIsDisplayed()
        composeTestRule.onNodeWithTag("impact_alert_confirm").assertIsDisplayed()
        composeTestRule.onNodeWithTag("impact_alert_dismiss").assertIsDisplayed()
    }
